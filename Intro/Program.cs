...
if (isAuthenticated)
{
    Console.WriteLine("Buton-->Hoşgeldin Muharrem");
}
else
{
...
customer1.FirstName = "Muharrem";
customer1.LastName = "Gedik";
customer1.CustomerNumber = "123456";

IndividualCustomer customer2 = new IndividualCustomer();
customer2.Id = 2;
customer2.NationalIdentity = "12512612512";
...
customer4.Id = 4;
customer4.Name = "Abc";
customer4.TaxNumber = "12341248987";
customer4.CustomerNumber = "125357";


// values types => int,bool,double ... sayısal değerlerde değer tipi değişkenler denir.
// referebce types => array,class,interface ...
int number1 = 10;
int number2 = 20;
number1 = number2;
number2 = 50;
